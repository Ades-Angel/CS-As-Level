...
coyote crow deer dog donkey duck eagle ferret frog goat goose hawk lion lizard
...
stork swan tiger trout turkey turtle weasel whale wolf wombat zebra'''.split()
...
def displayBoard(missedLetters, correctLetters, secretWord):
    ...
    for letter in blanks:  # Show the secret word with the spaces.
        print(letter, end=' ')
    print()
