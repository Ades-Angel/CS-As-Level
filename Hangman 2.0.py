...
HANGMAN_PICS = ['''
 ...
 / \  |
        ===''']
words = {'Colors': 'orange yellow green indigo violet white balck brown'.split(),
        'Shapes': '''square triangle rectangle circle ellipse rhombus trapeziod 
        ...
        fish frog goat leech lion lizaard monkey moose mouse otter owl panda
